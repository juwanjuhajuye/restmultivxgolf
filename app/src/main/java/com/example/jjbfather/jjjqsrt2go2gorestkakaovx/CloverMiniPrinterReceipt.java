 ...
 */
public class CloverMiniPrinterReceipt {
    Context mContext;

    int mCardPaymentCount = 0;

    public CloverMiniPrinterReceipt(Context paramContext) {
    ...
    public void openCashDrawerCloverMini(){
        GlobalMemberValues.cloverOpenDrawer();
    }

    public void printBatchCloverMini(final JSONObject data) {
...
//        Printer.ALIGNMENT_RIGHT
                ...
                GlobalMemberValues.cloverPrintText(textlist);
...
//                sendCommand(list, context);
                GlobalMemberValues.cloverPrintText(textlist);
                GlobalMemberValues.cloverPrintText("\n\n\n\n\n");
    ...
    public void printCashOutCloverMini(final JSONObject data) {
        Thread thread = new Thread() {
            @Override
            public void run() {
                int alignment = Printer.ALIGNMENT_LEFT;
...
//        Printer.ALIGNMENT_RIGHT
                ...
                if (data.toString().contains("cashinoutemployeenameyn")){
                    try {
                        str_cashinoutemployeenameyn = data.getString("cashinoutemployeenameyn");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                }
                if (str_cashinoutemployeenameyn == "Y" || str_cashinoutemployeenameyn.equals("Y")) {
                    if (data.toString().contains("employeename")){
                        try {
                            str_cashinoutemployeename = data.getString("employeename");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    }
                ...
                try {
                    str_cashinoutdate = data.getString("cashinoutdate");
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
//                list.add(nowTime.getBytes());
                ...
                try {
                    str_totalsaleamount = data.getString("totalsaleamount");
                    str_commissionamount = data.getString("commissionamount");
                    str_deliverypickupfeeamount = data.getString("deliverypickupfeeamount");
                    str_tipamount = data.getString("tipamount");

                    str_foodsaleamount = data.getString("foodsaleamount");
                    str_productsaleamount = data.getString("productsaleamount");
                    str_giftcardsaleamount = data.getString("giftcardsaleamount");
                    str_discountamount = data.getString("discountamount");
                    str_voidamount = data.getString("voidamount");

                    str_netsalesamount = data.getString("netsalesamount");
                    str_refundamount = data.getString("refundamount");
                    str_taxamount = data.getString("taxamount");
                    str_grosssalesamount = data.getString("grosssalesamount");

                    str_cashintotal = data.getString("cashintotal");
                    str_salescashtotal = data.getString("salescashtotal");
                    str_allcashtotal = data.getString("allcashtotal");

                    str_salechecktotal = data.getString("salechecktotal");

                    str_salecardtotal = data.getString("salecardtotal");
                    str_cardvisa = data.getString("cardvisa");
                    str_cnt_visa = cardReadCount(data.getString("cardvisa"));
                    str_cardmaster = data.getString("cardmaster");
                    str_cnt_master = cardReadCount(data.getString("cardmaster"));
                    ...
                    str_salegiftcardtotal = data.getString("salegiftcardtotal");
                    str_salepointtotal = data.getString("salepointtotal");

                    str_cashouttotal = data.getString("cashouttotal");
                    str_overshorttxt = data.getString("overshorttxt");
                    str_overshortamt = data.getString("overshortamt");
                    str_salecardtiptotal = data.getString("salecardtiptotal");
                    str_endcashtotal = data.getString("endcashtotal");

                    str_pickupfeeamount = data.getString("pickupfeeamount");
                    str_deliveryfeeamount = data.getString("deliveryfeeamount");
...
//                sendCommand(list, context);
    ...
    public void printBatchDetailCloverMini(final JSONObject data) {
        Thread thread = new Thread() {
            @Override
            public void run() {
...
//                sendCommand(list, context);
    ...
    private void ShowDialogInCloverMini(final JSONObject paramJsonData, String paramTitle, String paramContents,
        ...
        jjjdialogYesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (paramYesActionType) {
                    case "merchantcopy" : {
                        printSalesReceiptCloverMini1(paramJsonData);
                        break;
                    }
                    case "customercopy" : {
                        printSalesReceiptCloverMini2(paramJsonData);
                        break;
                    }
                    case "customercopy_void" : {
                        printVoidReceiptCloverMini2(paramJsonData);
                        break;
                    }
                    case "customercopy_return" : {
                        printReturnReceiptCloverMini2(paramJsonData);
                        break;
                    }
                    case "kitchenprint" : {
                        if (GlobalMemberValues.isCustomerSelectReceipt()) {
    ...
    public void printSalesReceiptCloverMini(final JSONObject data) {
        try {
        ...
        Thread thread1 = new Thread(){
            ...
            public void run(){
                ...
                if (jsonArray_creditcardtransaction.length() != 0) {
                    ...
                    for (int i = 0; i < cnt; i++) {
                        // 프린트 실행 (1) ------------------------------------------------------------
                        GlobalMemberValues.cloverPrintText(titleText1);
                        GlobalMemberValues.cloverPrintText(titleText2);
                        // ---------------------------------------------------------------------------
                        ...
                        // 프린트 실행 (2) --------------------------------------------------------------------
                        GlobalMemberValues.cloverPrintText(customerText);
                        // -----------------------------------------------------------------------------------
                        ...
                        if (new File(strFilePath).exists()) {
                            ...
                            str_signatureTxt = "\n\r        ";
                            str_signatureTxt += "         \r\n";
                            GlobalMemberValues.cloverPrintText(str_signatureTxt);
                            // -----------------------------------------------------------------------------------
                            ...
                            if (GlobalMemberValues.isSignedPrintYN()) {
                                // 서명 이미지 출력
                                GlobalMemberValues.cloverPrintToFilePath(strFilePath);
                        ...
                        if (!GlobalMemberValues.isStrEmpty(str_receiptfooter)) {
                            GlobalMemberValues.cloverPrintText(GlobalMemberValues.getPrintTxtCenterAlignment(str_receiptfooter, 32));
                        }
                        // --------------------------------------------------------------------------------------------------------
        ...
        if (mCardPaymentCount > 0 && GlobalMemberValues.isSignedPrintSeperately()) {
            ...
            printSalesReceiptCloverMini1(data);
        }
    }

    public void printSalesReceiptCloverMini1(final JSONObject data) {
        try {
            GlobalMemberValues.logWrite("waitingtime", "기다리는 시간1 : " + GlobalMemberValues.DELETEWAITING + "\n");
            Thread.sleep(500); // 0.5 초 기다림
        } catch (InterruptedException e) {
        ...
        Thread thread2 = new Thread(){
            ...
            public void run(){
                ...
                if (!GlobalMemberValues.isStrEmpty(str_customerPagerNumber)) {
                    GlobalMemberValues.cloverPrintText("Pager No. " + str_customerPagerNumber + "\n");
                }
                    ...
                    for (int i = 0; i < cnt; i++) {
                        ...
                        if (GlobalMemberValues.isModifierPrintYN()) {
                            if (!GlobalMemberValues.isStrEmpty(str_optiontxt) ||
                                ...
                                if (!GlobalMemberValues.isStrEmpty(str_optiontxt)) {
                                    str_option_additional_txt = "[Option]\n" + GlobalMemberValues.getModifierTxt(str_itemqty, str_optiontxt) + "\n";
                                }
                ...
                if (!GlobalMemberValues.isStrEmpty(str_deliverypickupfee)) {
                ...
                GlobalMemberValues.cloverPrintText(titleText1);
                GlobalMemberValues.cloverPrintText(titleText2);
                GlobalMemberValues.cloverPrintText(main_Text);
                // ---------------------------------------------------------------------------
                ...
                if (jsonArray_creditcardtransaction.length() != 0) {
                    ...
                    for (int i = 0; i < cnt; i++) {
                        ...
                        if (GlobalMemberValues.isSignedPrintSeperately()) {
                            ...
                            // 프린트 실행 (2) --------------------------------------------------------------------
                            GlobalMemberValues.cloverPrintText(cardsignedtxt);
                            // -----------------------------------------------------------------------------------
...
//                    GlobalMemberValues.cloverOpenDrawer();
    ...
    public void printSalesReceiptCloverMini2(final JSONObject data) {
        try {
            GlobalMemberValues.logWrite("waitingtime", "기다리는 시간1 : " + GlobalMemberValues.DELETEWAITING + "\n");
            Thread.sleep(500); // 0.5 초 기다림
        } catch (InterruptedException e) {
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                if (!GlobalMemberValues.isStrEmpty(str_customerPagerNumber)) {
                    GlobalMemberValues.cloverPrintText("Pager No. ");
                    GlobalMemberValues.cloverPrintText(str_customerPagerNumber + "\n");
                }
                ...
                GlobalMemberValues.cloverPrintText(merchantText);
                ...
                GlobalMemberValues.cloverPrintText(merchantText2);
                GlobalMemberValues.cloverPrintText("\n\n\n\n\n");
                // --------------------------------------------------------------------------------------
            }
        };
...
//            GlobalMemberValues.cloverOpenDrawer();
    ...
    public void executeKitchenPrint(JSONObject paramData) {
        ...
        if (GlobalMemberValues.getIntAtString(Payment.dbInit.dbExecuteReadReturnString(
            ...
            if (GlobalMemberValues.isCloverPrinterAll()) {
                // 커스텀 Alert 띄우기.. ----------------------------------------------------------------
                ...
                if (!GlobalMemberValues.isCloverPrinterKitchen()) {
                    Payment.openPaymentReview(mContext);
    ...
    public void printVoidReceiptCloverMini(final JSONObject data) {
        Thread thread = new Thread(){
            @SuppressLint("LongLogTag")
            @Override
            public void run() {
                ...
                if (jsonArray_saleitemlist.length() != 0)
                {
                    ...
                    for (int i = 0; i < cnt; i++)
                    {
                        ...
                        main_Text += Payment_stringBackSpace_Exch(10,str_itemname) +
                                Payment_stringFowardSpace_Exch(3, str_itemqty) +
                                Payment_stringFowardSpace_Exch(9, GlobalMemberValues.getCommaStringForDouble(str_itemprice))+
                                Payment_stringFowardSpace_Exch(9, combineStringForVoidPrint(str_itemamount))+ "\n";
    ...
    public void printVoidReceiptCloverMini2(final JSONObject data) {
        Thread thread = new Thread(){
            @SuppressLint("LongLogTag")
            @Override
            public void run() {
    ...
    public void printReturnReceiptCloverMini(final JSONObject data) {
        Thread thread = new Thread(){
            @SuppressLint("LongLogTag")
            @Override
            public void run() {
...
//                // card
    ...
    public void printReturnReceiptCloverMini2(final JSONObject data) {
        Thread thread = new Thread(){
            @SuppressLint("LongLogTag")
            @Override
            public void run() {
...
//                // card
    ...
    public void printTestCloverMini(final JSONObject data) {
    }
