 ...
 */
public class PrinterKitchen2 {
    public PrinterKitchen2() {
        // 프린트에 사용된 언어 설정
...
//            alert.show();
    ...
    public void printKitchenPosbank(final JSONObject data) {
        ...
        GlobalMemberValues.logWrite("kitchenPrintLog2", "프린트안 json -- 2 : " + data.toString() + "\n");
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                // 먼저 kitchen printer2 에 해당되는 food 가 있는지 확인한다. ---------------------------------------------------------------
                int tempItemCount = 0;
                if (!GlobalMemberValues.isStrEmpty(str_saleitemlist)) {
                    ...
                    for (int i = 0; i < strOrderItemsList.length; i++) {
                        ...
                        if (GlobalMemberValues.isKitchenPrinting("2", tempItemIdx)) {
                            tempItemCount++;
                        }
                    }
                }
                ...
                if (tempItemCount > 0) {
                    ...
                    if (!GlobalMemberValues.isStrEmpty(str_customerPagerNumber)) {
                        if (GlobalMemberValues.getKitchenPrinterTextSize().equals("R")) {
                            GlobalMemberValues.posbankPrintText3(GlobalMemberValues.PAGERNUMBERHEADERTXT + str_customerPagerNumber + "\n\n", 1, attribute, 3, false);
                        } else {
                    ...
                    titleText1 +=  " \n";
                    GlobalMemberValues.posbankPrintText3(titleText1, 1, attribute, 0, false);
                    ...
                    if (GlobalMemberValues.isKitchenOrderNumberSectionViewOn()) {
                        ...
                        GlobalMemberValues.posbankPrintText3(titleText2, 0, attribute, 1 + tempAddTextSize, false);
                    }
                     ...
                     **/
                    titleText3 = "------------------------------------------\r\n";
                    GlobalMemberValues.posbankPrintText3(titleText3, 1, attribute, 0, false);
                    ...
                    if (!GlobalMemberValues.isStrEmpty(str_saleitemlist)) {
                        ...
                        GlobalMemberValues.posbankPrintText3(main_Text, 0, attribute, 1 + tempAddTextSize, false);
                        //main_Text += "------------------------------------------\r\n";
                        //GlobalMemberValues.posbankPrintText3(main_Text, 1, attribute, 0, false);
                    }

                    if (!GlobalMemberValues.isStrEmpty(str_customermemo)) {
                        memo_Text = "[Note]" + "\n";
                        GlobalMemberValues.posbankPrintText3(memo_Text, 0, attribute, 0, false);
                        memo_Text = str_customermemo + "\n";
                        GlobalMemberValues.posbankPrintText3(memo_Text, 0, attribute, 1, false);
                        memo_Text = "------------------------------------------\r\n";
                        GlobalMemberValues.posbankPrintText3(memo_Text, 1, attribute, 0, false);
                    }

                    // receipt footer 프린터 ----------------------------------------------------------------------------------
                    String footer_kitchen = GlobalMemberValues.getReceiptFooterKitchen3();
                    if (!GlobalMemberValues.isStrEmpty(footer_kitchen)) {
                        GlobalMemberValues.posbankPrintText3(footer_kitchen, 1, 0, 0, false);
                    ...
                    GlobalMemberValues.posbankPrintText3(customerText, 0, attribute, 0, false);
        ...
        GlobalMemberValues.logWrite("kitchenPrintLogWanhaye", "지금까지 프린트 된 주방프린터 수2 : " + GlobalMemberValues.mKitchenPrintedQty + "\n");
        GlobalMemberValues.logWrite("kitchenPrintLogWanhaye", "전체 셋팅된 주방프린터 수2 : " + GlobalMemberValues.getSettingKitchenPrinterQty() + "\n");
    ...
    public void printTestPosbank(final JSONObject data) {
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                //PosbankPrinter3.mPrinter.kickOutDrawer(Printer.DRAWER_CONNECTOR_PIN2);
                GlobalMemberValues.disconnectPrinter3();
