...
public class API_menudatadelete_incloud extends AsyncTask {
    ...
    public API_menudatadelete_incloud() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Menu_Delete_ForAndroid.asp?" +
