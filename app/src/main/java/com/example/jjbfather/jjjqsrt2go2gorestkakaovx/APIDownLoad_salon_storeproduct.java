 ...
 */
public class APIDownLoad_salon_storeproduct extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_storeproduct";
    ...
    protected Object doInBackground(Object[] params) {
        try {
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isReturnCode && tagName.equals("ReturnCode")) {
                        ...
                        if (mApiReturnCode.equals("00")) {
                            isPossible = true;
                            GlobalMemberValues.logWrite("salon_storeproduct", "성공" + "\n");
                        } else {
                            isPossible = false;
                            GlobalMemberValues.logWrite("salon_storeproduct", "에러" + "\n");
                        }
                        GlobalMemberValues.logWrite("salon_storeproduct", "ReturnCode : " + mApiReturnCode + "\n");
                    }

                    if (isPossible && isDataTag) {
                        //GlobalMemberValues.logWrite("salon_storeproduct", "성공일때만.." + "\n");
                        ...
                        if (tagName.equals("productCode")) {
                            productCode = xpp.getText();
                        }
                        ...
                        if (tagName.equals("onhand")) {
                            onhand = xpp.getText();
                        }
                        if (tagName.equals("productalertqty")) {
                            productalertqty = xpp.getText();
                        }
                    }
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        mInsertSqlQuery = "insert into " + mDbTableName +
                                ...
                                " strOrgFileName, activeyn, productCode, taxfreeyn, dcapplyyn, onhand, productalertqty " +
                                " ) " +
                                " values (" +
                                ...
                                "'" + GlobalMemberValues.getDBTextAfterChecked(productCode, 0) + "', " +
                                "'" + GlobalMemberValues.getDBTextAfterChecked(taxfreeyn, 0) + "', " +
                                "'" + GlobalMemberValues.getDBTextAfterChecked(dcapplyyn, 0) + "', " +
                                "'" + GlobalMemberValues.getDBTextAfterChecked(onhand, 0) + "', " +
                                "'" + GlobalMemberValues.getDBTextAfterChecked(productalertqty, 0) + "' " +
                                ")";
                        ...
                        mUpdateSqlQuery = "update " + mDbTableName + " set " +
                                ...
                                " productCode = '" + GlobalMemberValues.getDBTextAfterChecked(productCode, 0) + "', " +
                                ...
                                " onhand = '" + GlobalMemberValues.getDBTextAfterChecked(onhand, 0) + "', " +
                                " productalertqty = '" + GlobalMemberValues.getDBTextAfterChecked(productalertqty, 0) + "' " +
                                " where idx = " + idx;
                        ...
                        GlobalMemberValues.logWrite("salon_storeproduct", "mQueryCollection : " + mQueryCollection);
                        /** 멤버변수 초기화 ******************************/
                        isDataTag = false;
                        mInsertSqlQuery = "";
                        mUpdateSqlQuery = "";
            ...
            GlobalMemberValues.logWrite("salon_storeproduct", "예외발생 : " + e.getMessage());
        }
        ...
        for (String strVec : sqlQueryVec) {
            GlobalMemberValues.logWrite("salon_storeproduct", "----------------------------\n");
            GlobalMemberValues.logWrite("salon_storeproduct", "VECTOR DATA : " + strVec + "\n");
            GlobalMemberValues.logWrite("salon_storeproduct", "----------------------------\n");
        }
        return null;
    }
