...
public class API_tableqrcodeset_tocloud extends AsyncTask{
    ...
    public API_tableqrcodeset_tocloud(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_TableQRCodeSet.asp?" + "sidx=" + GlobalMemberValues.STORE_INDEX + "&" + paramStr;
