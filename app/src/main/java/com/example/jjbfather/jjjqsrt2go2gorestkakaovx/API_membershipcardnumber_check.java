...
public class API_membershipcardnumber_check extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_membershipcardnumber_check(String paramMemUid, String paramMemCardNum) {
        if (!GlobalMemberValues.isStrEmpty(paramMemCardNum)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckMembershipcardnumber_ForAndroid.asp?memuid=" + paramMemUid + "&memcardnum=" +
                    GlobalMemberValues.getEncoderUtf8(GlobalMemberValues.getReplaceText(paramMemCardNum, " ", "|||")) + "&sidx=" + GlobalMemberValues.STORE_INDEX;
