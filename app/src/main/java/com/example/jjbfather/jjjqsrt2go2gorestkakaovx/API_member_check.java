...
public class API_member_check extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_member_check(String paramUid) {
        if (!GlobalMemberValues.isStrEmpty(paramUid)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckMember_ForAndroid.asp?uid=" +
                    GlobalMemberValues.getEncoderUtf8(GlobalMemberValues.getReplaceText(paramUid, " ", "|||")) + "&sidx=" + GlobalMemberValues.STORE_INDEX;
