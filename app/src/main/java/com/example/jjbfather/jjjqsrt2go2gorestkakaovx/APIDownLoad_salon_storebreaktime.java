 ...
 */
public class APIDownLoad_salon_storebreaktime extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_storebreaktime";
    ...
    protected Object doInBackground(Object[] params) {
        try {
            ...
            GlobalMemberValues.logWrite("breaktimelogjjj", "url : " + mStrUrl + "\n");
