...
public class API_weborder_customer_arrive_confirm extends AsyncTask {
    final String TAG = "NEWORDERCHECKAPI_CUSTOMER_ARRIVE_CONFIRM";
    ...
    public API_weborder_customer_arrive_confirm(String paramStr, String paramSalesCode) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_curbside_arrivalconfirm.asp?" + "sidx=" + paramStr + "&salesCode=" + paramSalesCode + "&stcode=" + GlobalMemberValues.STATION_CODE;
//            mStrUrl = "https://app.2go2go.com/API/" + "API_Check_NewCurbside_ForAndroid.asp?sidx=" + paramStr + "&stcode=" + GlobalMemberValues.STATION_CODE;
