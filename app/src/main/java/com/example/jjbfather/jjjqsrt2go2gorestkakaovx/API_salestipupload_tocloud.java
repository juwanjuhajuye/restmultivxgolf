...
public class API_salestipupload_tocloud extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_salestipupload_tocloud(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_UP_SalesTip_item_ForAndroid.asp?" + paramStr;
            /**
