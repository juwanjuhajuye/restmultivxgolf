...
public class API_weborder_deliverytakeaway_changestatus extends AsyncTask {
    final String TAG = "API_weborder_deliverytakeaway_changestatus";
    ...
    public API_weborder_deliverytakeaway_changestatus(String paramSalesCode, String paramChangeStatus) {
        if (!GlobalMemberValues.isStrEmpty(paramSalesCode)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Weborder_DeliveryTakeawayChangeStatus_ForAndroid.asp?" +
                    "sidx=" + GlobalMemberValues.STORE_INDEX + "&salesCode=" + paramSalesCode + "&changestatus=" + paramChangeStatus;

            GlobalMemberValues.logWrite(TAG + "log", "url : " + mStrUrl + "\n");
        }
    }
