...
public class API_Online_Kiosk_Data_ForEOD extends AsyncTask {
    final String TAG = "API_Online_Kiosk_Data_ForEOD_Log";
    ...
    public API_Online_Kiosk_Data_ForEOD(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Online_Kiosk_Data_ForEOD.asp?sidx=" + GlobalMemberValues.STORE_INDEX + "&stcode=" + GlobalMemberValues.STATION_CODE +
                    "&searchDate=" + paramStr;
