 ...
 */
public class APIDownLoad_salon_storememberlevel extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_storememberlevel";
            ...
            while (eventType != XmlPullParser.END_DOCUMENT){
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isPossible && isDataTag) {
                        ...
                        if (tagName.equals("levelname")) {
                            levelname = xpp.getText();
                        }
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        mInsertSqlQuery = "insert into " + mDbTableName +
                                " ( " +
                                " idx, scode, sidx, aid, levelname, pointratio, useyn, delyn, wdate, edate " +
                                " ) " +
                                " values (" +
                                ...
                                "'" + GlobalMemberValues.getDBTextAfterChecked(levelname, 0) + "', " +
                                ...
                                "'" + GlobalMemberValues.getDBTextAfterChecked(edate, 0) + "' " +
                                ")";
                        ...
                        mUpdateSqlQuery = "update " + mDbTableName + " set " +
                                ...
                                " levelname = '" + GlobalMemberValues.getDBTextAfterChecked(levelname, 0) + "', " +
                                ...
                                " edate = '" + GlobalMemberValues.getDBTextAfterChecked(edate, 0) + "' " +
                                " where idx = " + idx;
