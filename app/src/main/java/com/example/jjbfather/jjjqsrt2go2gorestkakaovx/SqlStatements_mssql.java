...
public class SqlStatements_mssql {
    // 테이블 salon_storestationinfo 생성쿼리
    public static final String SQL_CREATE_SALONSTORESTATIONINFO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationinfo') " +

                    "CREATE TABLE salon_storestationinfo ( " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICESUBSETMENU =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_sub_setmenu') " +
                    "CREATE TABLE salon_storeservice_sub_setmenu ( " +
                    "idx INTEGER PRIMARY KEY identity,"+
                    "sidx int,"+
                    "midx int,"+
                    "svcidx int,"+
    ...
    public static final String SQL_CREATE_SALONSTORESERVICESUBORDER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_sub_order') " +

                    "CREATE TABLE salon_storeservice_sub_order ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "soidx int," +
                    "ordervalue int" +
                    ")";
    ...
    public static final String SQL_CREATE_SALONSTORESERVICESUB =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_sub') " +

                    "CREATE TABLE salon_storeservice_sub ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "midx int, " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICEMAINORDER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_main_order') " +

                    "CREATE TABLE salon_storeservice_main_order ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "oidx int," +
                    "ordervalue int" +
                    ")";
    ...
    public static final String SQL_CREATE_SALONSTORESERVICEMAIN =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_main') " +

                    "CREATE TABLE salon_storeservice_main ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREPRODUCTIPKOHISTORY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeproduct_ipkohistory') " +

                    "CREATE TABLE salon_storeproduct_ipkohistory ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "SEQ int, " +
                    "sidx int, " +
                    "product_idx int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREPRODUCT =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeproduct') " +

                    "CREATE TABLE salon_storeproduct ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
                    "name nvarchar(200), " +
                    "description ntext, " +
    ...
    public static final String SQL_CREATE_SALONSTOREPHOTO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storephoto') " +

                    "CREATE TABLE salon_storephoto ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
                    "photo nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSTOREPG =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storePG') " +

                    "CREATE TABLE salon_storePG ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
                    "pgidx int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREINFOWORKTIMEFORPOS =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeinfo_worktime_forPOS') " +

                    "CREATE TABLE salon_storeinfo_worktime_forPOS ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREINFOWORKTIME =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeinfo_worktime') " +

                    "CREATE TABLE salon_storeinfo_worktime ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
                    "sworktime int, " +
                    "eworktime int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREINFO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeinfo') " +

                    "CREATE TABLE salon_storeinfo ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "name nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSTOREGIFTCARD =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storegiftcard') " +

                    "CREATE TABLE salon_storegiftcard ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
                    "name nvarchar(200), " +
                    "description ntext, " +
    ...
    public static final String SQL_CREATE_SALONSTOREGENERAL =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storegeneral') " +

                    "CREATE TABLE salon_storegeneral ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREEMPLOYEEWORKWEEKDAY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeemployee_workweekday') " +

                    "CREATE TABLE salon_storeemployee_workweekday ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "employeeidx int," +
    ...
    public static final String SQL_CREATE_SALONSTOREEMPLOYEEWORKTIME =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeemployee_worktime') " +

                    "CREATE TABLE salon_storeemployee_worktime ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "employeeidx int, " +
                    "sworktime int, " +
                    "eworktime int, " +
    ...
    public static final String SQL_CREATE_SALONSTOREEMPLOYEELOGINLOG =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeemployee_loginlog') " +

                    "CREATE TABLE salon_storeemployee_loginlog ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int, " +
                    "eid nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSTOREEMPLOYEE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeemployee') " +

                    "CREATE TABLE salon_storeemployee ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int, " +
                    "name nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONMEMBER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_member') " +
    ...
    public static final String SQL_CREATE_SALONINFO2 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_info2') " +

                    "CREATE TABLE salon_info2 ( " +
                    "scode nvarchar(50), " +
                    "status nvarchar(2), " +
                    "pagetype nvarchar(2), " +
                    "mdate datetime, " +
    ...
    public static final String SQL_CREATE_SALONINFO1 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_info1') " +

                    "CREATE TABLE salon_info1 ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "name nvarchar(50), " +
                    "sid nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONGENERAL =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_general') " +

                    "CREATE TABLE salon_general ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "managerpwd nvarchar(50), " +
                    "tax1 float DEFAULT (0.0), " +
    ...
    public static final String SQL_CREATE_RESERVATIONTIME =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'reservation_time') " +
                    ...
                    "employee_idx int, " +
                    "rtime nvarchar(50), " +
                    "ent_nal datetime DEFAULT getdate(),"+
                    ")";
    ...
    public static final String SQL_CREATE_RESERVATIONSERVICE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'reservation_service') " +
    ...
    public static final String SQL_CREATE_RESERVATION =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'reservation') " +
    ...
    public static final String SQL_CREATE_PGINFO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'pg_info') " +
    ...
    public static final String SQL_CREATE_MEMBER2 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'member2') " +
    ...
    public static final String SQL_CREATE_MEMBER1 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'member1') " +
    ...
    public static final String SQL_CREATE_MEMBERMILEAGE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'member_mileage') " +

                    "CREATE TABLE member_mileage ( " +
                    "mdate datetime DEFAULT getdate(),"+
                    "contents nvarchar(200), " +
                    "mileage money, " +
                    "uid nvarchar(200), " +
                    "mcase nvarchar(50), " +                            // 1 : 적립    2 : 사용
                    "seno INTEGER PRIMARY KEY identity, " +
                    "membershipcardno nvarchar(200), " +
                    "sid nvarchar(100), " +
    ...
    public static final String SQL_CREATE_COUPONREGISTRATIONNO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'coupon_registration_no') " +

                    "CREATE TABLE coupon_registration_no ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "reg_no nvarchar(50), " +
                    "useyn nvarchar(50), " +
                    "scode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_COUPONMAILINGPUSHSEND =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'coupon_mailingpush_send') " +

                    "CREATE TABLE coupon_mailingpush_send ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "cp_idx int, " +
                    "scode nvarchar(50), " +
                    "sidx int, " +
                    ...
                    "send_nal datetime DEFAULT getdate()"+
                    ")";
    ...
    public static final String SQL_CREATE_COUPONISSUEHISTORY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'coupon_issue_history') " +
    ...
    public static final String SQL_CREATE_COUPONIMGTYPE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'coupon_imgtype') " +

                    "CREATE TABLE coupon_imgtype ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "cidx int, " +
                    "imgonly nchar(2)" +
                    ")";
    ...
    public static final String SQL_CREATE_COUPON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'coupon') " +
    ...
    public static final String SQL_CREATE_ADMIN =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'admin') " +
    ...
    public static final String SQL_CREATE_TEMPSALECART =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart') " +

                    "CREATE TABLE temp_salecart ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    public static final String SQL_CREATE_TEMPSALECARTORDERED =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_ordered') " +

                    "CREATE TABLE temp_salecart_ordered ( " +
                    "idx int, " +
                    "holdcode nvarchar(100), " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSTOREGIFTCARDNUMBER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storegiftcard_number') " +

                    "CREATE TABLE salon_storegiftcard_number ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSTOREGIFTCARDNUMBERHISTORY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storegiftcard_number_history') " +

                    "CREATE TABLE salon_storegiftcard_number_history ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
                    "gcNumber nvarchar(100), " +
    ...
    public static final String SQL_CREATE_SALONSTORESALESDETAIL =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_detail') " +

                    "CREATE TABLE salon_sales_detail ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    ...
                    "saleDate datetime DEFAULT getdate(),"+              // 판매일시
    ...
    public static final String SQL_CREATE_SALONSTORESALES =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales') " +
                    ...
                    "deliverydate datetime DEFAULT getdate(),"+                  // 예약배송일시
                    "deliverytakeaway nvarchar(10) DEFAULT 'D', " +      // 수령방법
    ...
    public static final String SQL_CREATE_SALONSALESTIP =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_tip') " +

                    "CREATE TABLE salon_sales_tip ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONCLOCKINOUT =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_clockinout') " +

                    "CREATE TABLE salon_clockinout ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
                    "stcode nvarchar(50), " +
                    "employeeIdx int, " +
                    "employeeName nvarchar(100), " +
                    "clockinDate datetime DEFAULT getdate(),"+
                    "clockinDay nvarchar(10) NULL, " +
                    "clockinTime nvarchar(10) NULL, " +
                    "clockoutDate datetime DEFAULT getdate(),"+
    ...
    public static final String SQL_CREATE_SYNCDATALOG =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'sync_data_log') " +
    ...
    public static final String SQL_CREATE_BASICPOSINFORMATION =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'basic_pos_information') " +

                    "CREATE TABLE basic_pos_information ( " +
                    "sid nvarchar(50), " +
                    "scode nvarchar(50), " +
                    "sname nvarchar(100), " +
                    "sidx int," +
    ...
    public static final String SQL_CREATE_SALONSALESCARD =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_card') " +

                    "CREATE TABLE salon_sales_card ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100), " +                         // 세일코드
    ...
    public static final String SQL_CREATE_SALONSTORESALESRETURN =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_return') " +

                    "CREATE TABLE salon_sales_return ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100), " +                         // 세일코드
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSSYSTEM =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_system') " +

                    "CREATE TABLE salon_storestationsettings_system ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
                    ...
                    "startpagernum smallint DEFAULT 1, " +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER2 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter2') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter2 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER3 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter3') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter3 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER4 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter4') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter4 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER5 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter5') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter5 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER6 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter6') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter6 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSPAYMENTGATEWAY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_paymentgateway') " +

                    "CREATE TABLE salon_storestationsettings_paymentgateway ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_MEMBER_MEMO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'member_memo') " +
    ...
    public static final String SQL_CREATE_SALONSTOREMEMOSEL =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storememosel') " +

                    "CREATE TABLE salon_storememosel ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_CLOUDDBBACKUPLOG =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'clouddbbackup_log') " +

                    "CREATE TABLE clouddbbackup_log ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
                    "num int NULL, " +
    ...
    public static final String SQL_CREATE_SALONSTOREPART =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storepart') " +

                    "CREATE TABLE salon_storepart ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSTOREPARTEMPLOYEE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storepart_employee') " +

                    "CREATE TABLE salon_storepart_employee ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "partidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSALESBATCH =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_batch') " +

                    "CREATE TABLE salon_sales_batch ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100), " +                         // 세일코드
                    "delyn nvarchar(2) DEFAULT 'N'," +                   // 삭제여부 (Y : 삭제     N : 삭제아님)
                    "wdate datetime DEFAULT getdate()"+
    ...
    public static final String SQL_CREATE_SALONSALESBATCHJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_batch_json') " +

                    "CREATE TABLE salon_sales_batch_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "jsonstr ntext, " +                         // 세일코드
                    "delyn nvarchar(2) DEFAULT 'N'," +                   // 삭제여부 (Y : 삭제     N : 삭제아님)
                    "wdate datetime DEFAULT getdate()"+
    ...
    public static final String SQL_CREATE_TEMPSALECART_DELIVERYINFO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_deliveryinfo') " +

                    "CREATE TABLE temp_salecart_deliveryinfo ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100), " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
                    ...
                    "delyn varchar(2) DEFAULT 'N', " +                   // 삭제여부
                    "wdate datetime DEFAULT getdate(),"+    // 저장일시
    ...
    public static final String SQL_CREATE_SALONSALESWEBPUSHREALTIME =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_web_push_realtime') " +

                    "CREATE TABLE salon_sales_web_push_realtime ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICEOPTIONBTN =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_option_btn') " +

                    "CREATE TABLE salon_storeservice_option_btn ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int, " +
                    "midx int, " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICEOPTION =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_option') " +

                    "CREATE TABLE salon_storeservice_option ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int, " +
                    "midx int, " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICEOPTIONITEM =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_option_item') " +

                    "CREATE TABLE salon_storeservice_option_item ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int, " +
                    "midx int, " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICEADDITIONAL =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_additional') " +

                    "CREATE TABLE salon_storeservice_additional ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int, " +
                    "midx int, " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICECOMMONMODIFIER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_commonmodifier') " +

                    "CREATE TABLE salon_storeservice_commonmodifier ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int, " +
                    "optionname nvarchar(200), " +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICECOMMONMODIFIERITEM =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_commonmodifier_item') " +

                    "CREATE TABLE salon_storeservice_commonmodifier_item ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int, " +
                    "optionidx int, " +
    ...
    public static final String SQL_CREATE_SALONSALESCASHINOUTHISTORY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_cashintout_history') " +

                    "CREATE TABLE salon_sales_cashintout_history ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
                    "employeeIdx int, " +
    ...
    public static final String SQL_CREATE_SALONEMPLOYEELOGINOUTHISTORY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_employee_loginout_history') " +

                    "CREATE TABLE salon_employee_loginout_history ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
                    ...
                    "loginoutdatetime datetime DEFAULT getdate(),"+
                    "cashoutNum int DEFAULT 0, " +                             // cash out 여부
                    "endofdayNum int DEFAULT 0 " +                             // End of Day 여부
                    ")";
    ...
    public static final String SQL_CREATE_MEMBERSALEVISIT =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'member_salevisit') " +

                    "CREATE TABLE member_salevisit ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "uid nvarchar(200), " +
                    "name nvarchar(50), " +
                    "lastvisitForSale datetime " +
    ...
    public static final String SQL_CREATE_SALONSTORECASHINOUTREASON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_cashinoutreason') " +

                    "CREATE TABLE salon_store_cashinoutreason ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
                    "description nvarchar(200), " +
                    "wdate datetime DEFAULT getdate()"+
    ...
    public static final String SQL_CREATE_SALONSALESCASHOUTJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_cashout_json') " +

                    "CREATE TABLE salon_sales_cashout_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONSALESCUSTOMERORDERNUMBER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_customerordernumber') " +

                    "CREATE TABLE salon_sales_customerordernumber ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONSALESCUSTOMERPAGERNUMBER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_customerpagernumber') " +

                    "CREATE TABLE salon_sales_customerpagernumber ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONSALESPHONEORDERNUMBER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_phoneordernumber') " +

                    "CREATE TABLE salon_sales_phoneordernumber ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONSTOREDELIVERYCOMPANY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_deliveryappcompany') " +

                    "CREATE TABLE salon_store_deliveryappcompany ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int," +
    ...
    public static final String SQL_CREATE_TEMPSALECARTOPTIONADD =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_optionadd') " +

                    "CREATE TABLE temp_salecart_optionadd ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100), " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_TEMPSALECARTOPTIONADDGM =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_optionadd_gm') " +

                    "CREATE TABLE temp_salecart_optionadd_gm ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100), " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_TEMPSALECARTOPTIONADDIMSI =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_optionadd_imsi') " +

                    "CREATE TABLE temp_salecart_optionadd_imsi ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100), " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_TEMPSALECARTOPTIONADDIMSIGM =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_optionadd_imsi_gm') " +

                    "CREATE TABLE temp_salecart_optionadd_imsi_gm ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100), " +
                    "sidx int, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSALESRECEIPTJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_receipt_json') " +

                    "CREATE TABLE salon_sales_receipt_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100), " +                         // 세일코드
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSALESKITCHENJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_kitchen_json') " +

                    "CREATE TABLE salon_sales_kitchen_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100), " +                         // 세일코드
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSALESCASHINOUTHISTORYLIST =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_cashintout_history_cashlist') " +

                    "CREATE TABLE salon_sales_cashintout_history_cashlist ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "chidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSTORESERVICESUBTIMEMENUPRICE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeservice_sub_timemenuprice') " +

                    "CREATE TABLE salon_storeservice_sub_timemenuprice ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int, " +
                    "midx int, " +
    ...
    public static final String SQL_CREATE_SALONSALESSIGNEDIMG =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_signedimg') " +

                    "CREATE TABLE salon_sales_signedimg ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "sidx int NULL," +
                    "salesCode nvarchar(100), " +
    ...
    public static final String SQL_CREATE_TEMPMILEAGECART =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_mileagecart') " +

                    "CREATE TABLE temp_mileagecart ( " +
                    "uid nvarchar(200), " +
                    "mileage money DEFAULT 0.0 " +
                    ")";
    ...
    public static final String SQL_CREATE_SALONSTOREDISCOUNTBUTTON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storediscountbutton') " +

                    "CREATE TABLE salon_storediscountbutton ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_KITCHENPRINTINGLOG =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'kitchenprinting_log') " +

                    "CREATE TABLE kitchenprinting_log ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORETARE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_tare') " +

                    "CREATE TABLE salon_store_tare ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSALESENDOFDAYJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_endofday_json') " +

                    "CREATE TABLE salon_sales_endofday_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONSALESCASHOUTEMP =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_cashout_emp') " +

                    "CREATE TABLE salon_sales_cashout_emp ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONKITCHENPRINTINGDATA =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_kitchenprintingdata') " +

                    "CREATE TABLE salon_sales_kitchenprintingdata ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(20), " +
    ...
    public static final String SQL_CREATE_SALONCONNECTEDBLUETOOTHINFO =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_connectedbluetoothinfo') " +

                    "CREATE TABLE salon_connectedbluetoothinfo ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    public static final String SQL_CREATE_SALONSTORERESTAURANTTABLE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_restaurant_table') " +

                    "CREATE TABLE salon_store_restaurant_table ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "zoneidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSTORERESTAURANTTABLEZONE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_restaurant_tablezone') " +

                    "CREATE TABLE salon_store_restaurant_tablezone ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONSTORERESTAURANTTABLESPLIT =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_restaurant_table_split') " +

                    "CREATE TABLE salon_store_restaurant_table_split ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
//                    "tableidx int null, " +
                    "tableidx nvarchar(100) DEFAULT '',  " +
    ...
    public static final String SQL_CREATE_SALONSTORERESTAURANTTABLEPEOPLECNT =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_restaurant_table_peoplecnt') " +

                    "CREATE TABLE salon_store_restaurant_table_peoplecnt ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
//                    "tableidx int null, " +
                    "tableidx nvarchar(100) DEFAULT '',  " +
                    "subtablenum smallint DEFAULT 1, " +
    ...
    public static final String SQL_CREATE_SALONSTORERESTAURANTTABLEMERGE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_restaurant_table_merge') " +

                    "CREATE TABLE salon_store_restaurant_table_merge ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
//                    "tableidx int null, " +
                    "tableidx nvarchar(100) DEFAULT '',  " +
                    "holdcode nvarchar(200) null, " +
    ...
    public static final String SQL_CREATE_SALONSTORECURBSIDEPICKUP =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_curbsidepickup') " +

                    "CREATE TABLE salon_store_curbsidepickup ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100) null, " +
    ...
    public static final String SQL_CREATE_SALONSTORECURBSIDENEWSIDEMENU =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_store_curbsidenewsidemenu') " +

                    "CREATE TABLE salon_store_curbsidenewsidemenu ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100) null, " +
...
//                    "tableidx int null, " +
    ...
    // 테이블 temp_salecart_del 생성쿼리
    public static final String SQL_CREATE_TEMPSALECARTDEL =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_del') " +

                    "CREATE TABLE temp_salecart_del ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100), " +
                    "sidx int null, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSALESKITCHENPRINTINGDATAJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_kitchenprintingdata_json') " +

                    "CREATE TABLE salon_sales_kitchenprintingdata_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100) null, " +
    ...
    public static final String SQL_CREATE_SALONSTORESALESRETURNBYEMPLOYEE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_return_byemplyee') " +

                    "CREATE TABLE salon_sales_return_byemplyee ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    ...
                    "wdate datetime DEFAULT getdate(), " +     // 리턴일시
    ...
    // 테이블 salon_newcartcheck_bystation 생성쿼리
    public static final String SQL_CREATE_SALONNEWCARTCHECKBYSTATION =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_newcartcheck_bystation') " +

                    "CREATE TABLE salon_newcartcheck_bystation ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    // 테이블 salon_selectedtableidx_bystation 생성쿼리
    public static final String SQL_CREATE_SALONSELECTEDTABLEIDXBYSTATION =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_selectedtableidx_bystation') " +

                    "CREATE TABLE salon_selectedtableidx_bystation ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "stcode nvarchar(50) null, " +
                    "tableidx nvarchar(30) default '', " +
                    "wdate datetime DEFAULT getdate() " +
    ...
    // 테이블 temp_salecart_del2 생성쿼리
    public static final String SQL_CREATE_TEMPSALECARTDEL2 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_salecart_del2') " +
                    "CREATE TABLE temp_salecart_del2 ( " +
    ...
    public static final String SQL_CREATE_BILLLIST =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'bill_list') " +
    ...
    public static final String SQL_CREATE_BILLLISTPAID =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'bill_list_paid') " +

                    "CREATE TABLE bill_list_paid ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    public static final String SQL_CREATE_CARDPROCESSINGDATA =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'card_processing_data') " +

                    "CREATE TABLE card_processing_data ( " +
    ...
    public static final String SQL_CREATE_SALONSTORESPECIALREQUEST =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storespecialrequest') " +

                    "CREATE TABLE salon_storespecialrequest ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER_LABEL1 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter_label1') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter_label1 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER_LABEL2 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter_label2') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter_label2 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER_LABEL3 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter_label3') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter_label3 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER_LABEL4 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter_label4') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter_label4 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER_LABEL5 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter_label5') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter_label5 ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSMSTEXTSAMPLE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storesmstextsample') " +

                    "CREATE TABLE salon_storesmstextsample ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSALESTIPSPLIT =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_tip_split') " +

                    "CREATE TABLE salon_sales_tip_split ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salescode nvarchar(100) default '', " +
                    "sidx int null, " +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSTORESTATIONSETTINGSDEVICEPRINTER_MASTER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storestationsettings_deviceprinter_master') " +

                    "CREATE TABLE salon_storestationsettings_deviceprinter_master ( " +
                    "idx INTEGER PRIMARY KEY identity," +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_bTNLOGS =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'btn_logs') " +

                    "CREATE TABLE btn_logs ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salescode nvarchar(100) default '', " +
                    "holdcode nvarchar(200) default '', " +
                    "scode nvarchar(50) default '', " +
                    "sidx int null, " +
    ...
    public static final String SQL_CREATE_BILLLISTRECEIPTJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'bill_list_receipt_json') " +

                    "CREATE TABLE bill_list_receipt_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100), " +                         // 세일코드
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_TEMPITEMPRINTING =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'temp_item_printing') " +

                    "CREATE TABLE temp_item_printing ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    // 04252023
    // 테이블 salon_newcartcheck_bystation2 생성쿼리
    public static final String SQL_CREATE_SALONNEWCARTCHECKBYSTATION2 =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_newcartcheck_bystation2') " +

                    "CREATE TABLE salon_newcartcheck_bystation2 ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100) null, " +
                    "stcode nvarchar(100) null, " +
                    "tableidx nvarchar(30) default '', " +
    ...
    // 04252023
    // 테이블 salon_table_statuschange 생성쿼리
    public static final String SQL_CREATE_SALONTABLESTATUSCHANGE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_table_statuschange') " +

                    "CREATE TABLE salon_table_statuschange ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100) null, " +
                    "stcode nvarchar(100) null, " +
                    "tableidx nvarchar(30) default '', " +
    ...
    // 05012023
    // 테이블 salon_billprinted 생성쿼리
    public static final String SQL_CREATE_SALONBILLPRINTED =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_billprinted') " +

                    "CREATE TABLE salon_billprinted ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "holdcode nvarchar(100) null, " +
                    "stcode nvarchar(100) null, " +
                    "wdate datetime DEFAULT getdate() " +
    ...
    public static final String SQL_CREATE_LABELPRINTEDJSON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'labelprinted_json') " +

                    "CREATE TABLE labelprinted_json ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
                    "stcode nvarchar(50), " +
    ...
    public static final String SQL_CREATE_SALONSTOREEMPLOYEEROLE =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeemployeerole') " +

                    "CREATE TABLE salon_storeemployeerole ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), "      +                         // 살롱코드
                    "sidx int NULL," +
    ...
    public static final String SQL_CREATE_SALONBILLPRINTEDITEMQTY =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_billprinted_itemqty') " +

                    "CREATE TABLE salon_billprinted_itemqty ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    public static final String SQL_CREATE_SALONITEMDELETEREASON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_itemdeletereason') " +

                    "CREATE TABLE salon_itemdeletereason ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
    ...
    public static final String SQL_CREATE_SALONSTOREITEMDELETEREASON =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_storeitemdeletereason') " +

                    "CREATE TABLE salon_storeitemdeletereason ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "scode nvarchar(50), " +
                    "sidx int NULL," +
                    "stcode nvarchar(50)," +
    ...
    public static final String SQL_CREATE_SALONSALESKITCHENPRINTINGDATAJSONTORDER =
            " IF NOT EXISTS " +
                    " (SELECT * FROM INFORMATION_SCHEMA.tables WITH(NOLOCK) WHERE TABLE_SCHEMA = 'dbo' AND TABLE_NAME = 'salon_sales_kitchenprintingdata_json_torder') " +

                    "CREATE TABLE salon_sales_kitchenprintingdata_json_torder ( " +
                    "idx INTEGER PRIMARY KEY identity, " +
                    "salesCode nvarchar(100) null, " +
                    "scode nvarchar(50) null, " +
                    "sidx int null, " +
