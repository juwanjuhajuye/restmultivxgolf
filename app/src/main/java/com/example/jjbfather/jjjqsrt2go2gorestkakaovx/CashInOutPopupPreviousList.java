...
public class CashInOutPopupPreviousList extends Activity {
    final String TAG = "previousListLog";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cash_in_out_popup_previous_list);
        this.setFinishOnTouchOutside(false);

        int parentLnWidth = (GlobalMemberValues.getDisplayWidth(this) / 10) * 4;
    ...
    private void viewPreviousList() throws JSONException {
        ...
        cashoutNumTitleTv.setLayoutParams(new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 2.0f));
        ...
        strQuery = "select cashoutNum, jsonstr from salon_sales_cashout_json " +
                " where " +
                " employeeIdx = '" + GlobalMemberValues.GLOBAL_EMPLOYEEINFO.empIdx + "' " +
                " and cashoutnum > 0 " +
                " and delyn = 'N' " +
                " order by idx desc limit 30 ";
        ...
        while (cashoutListCursor.moveToNext()) {
            ...
            String jsonStr = GlobalMemberValues.getDBTextAfterChecked(cashoutListCursor.getString(1), 1);
            ...
            if (!GlobalMemberValues.isStrEmpty(jsonStr)) {
                ...
                if (jsonStrObj.toString().contains("salesoverview_cashoutdate")){
                    ...
                    cashoutNumTv.setText(strCashoutNum);
                    ...
                    cashoutNumTv.setLayoutParams(new LinearLayout.LayoutParams(0, ViewGroup.LayoutParams.MATCH_PARENT, 2.0f));
