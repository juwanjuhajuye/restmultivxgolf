...
public class API_member_check_for_deliverytakeaway extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_member_check_for_deliverytakeaway(String paramUid) {
        if (!GlobalMemberValues.isStrEmpty(paramUid)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckMember_DeliveryTakeaway_ForAndroid.asp?sidx=" + GlobalMemberValues.STORE_INDEX + "&uid=" +
                    GlobalMemberValues.getEncoderUtf8(GlobalMemberValues.getReplaceText(paramUid, " ", "|||"));
