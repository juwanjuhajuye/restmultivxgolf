...
public class API_weborder_settableidxincloud extends AsyncTask {
    final String TAG = "SETTABLEIDXLOGTAG";
    ...
    public API_weborder_settableidxincloud(String paramStr, String paramTableIdx) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Check_SetTableIdx_ForAndroid.asp?sidx=" + paramStr
                    + "&stcode=" + GlobalMemberValues.STATION_CODE + "&tableidx=" + paramTableIdx + "&flags=" + GlobalMemberValues.SAVEORDELETE;
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isPossible && isDataTag) {
                        ...
                        if (tagName.equals("ReturnValue")) {
                            ...
                            GlobalMemberValues.SAVEORDELETE = "";
                        }
                    }
