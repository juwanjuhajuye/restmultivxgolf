 ...
 */
public class PrinterKitchen1 {
    public PrinterKitchen1() {
        // 프린트에 사용된 언어 설정
    ...
    public void printKitchenPosbank(final JSONObject data) {
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                GlobalMemberValues.logWrite("kitchenPrintLogWanhayetxt", "str_saleitemlist : " + str_saleitemlist + "\n");
                ...
                if (tempItemCount > 0) {
                    ...
                    if (!GlobalMemberValues.isStrEmpty(str_customerPagerNumber)) {
                        if (GlobalMemberValues.getKitchenPrinterTextSize().equals("R")) {
                            GlobalMemberValues.posbankPrintText2(GlobalMemberValues.PAGERNUMBERHEADERTXT + str_customerPagerNumber + "\n\n", 1, attribute, 3, false);
                        } else {
                    ...
                    titleText1 +=  " \n";
                    GlobalMemberValues.posbankPrintText2(titleText1, 1, attribute, 0, false);
                    ...
                    if (GlobalMemberValues.isKitchenOrderNumberSectionViewOn()) {
                        ...
                        GlobalMemberValues.posbankPrintText2(titleText2, 0, attribute, 1 + tempAddTextSize, false);
                    }

                    GlobalMemberValues.logWrite("kitchenPrintLogWanhayetxt", "titleText2 : " + titleText2 + "\n");
                     ...
                     **/
                    titleText3 = "------------------------------------------\r\n";
                    GlobalMemberValues.posbankPrintText2(titleText3, 1, attribute, 0, false);
                    ...
                    if (!GlobalMemberValues.isStrEmpty(str_saleitemlist)) {
                        ...
                        GlobalMemberValues.posbankPrintText2(main_Text, 0, attribute, 1 + tempAddTextSize, false);
                        //main_Text += "------------------------------------------\r\n";
                        //GlobalMemberValues.posbankPrintText2(main_Text, 1, attribute, 0, false);
                    }

                    if (!GlobalMemberValues.isStrEmpty(str_customermemo)) {
                        memo_Text = "[Note]" + "\n";
                        GlobalMemberValues.posbankPrintText2(memo_Text, 0, attribute, 0, false);
                        memo_Text = str_customermemo + "\n";
                        GlobalMemberValues.posbankPrintText2(memo_Text, 0, attribute, 1, false);
                        memo_Text = "------------------------------------------\r\n";
                        GlobalMemberValues.posbankPrintText2(memo_Text, 1, attribute, 0, false);
                    }

                    // receipt footer 프린터 ----------------------------------------------------------------------------------
                    String footer_kitchen = GlobalMemberValues.getReceiptFooterKitchen2();
                    if (!GlobalMemberValues.isStrEmpty(footer_kitchen)) {
                        GlobalMemberValues.posbankPrintText2(footer_kitchen, 1, 0, 0, false);
                    ...
                    GlobalMemberValues.posbankPrintText2(customerText, 0, attribute, 0, false);
