...
public class API_serverconnection_check extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_serverconnection_check() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_CheckServerConnection_ForAndroid.asp";
    }
