...
class API_sidemenuorder_confirm extends AsyncTask{
    ...
    public API_sidemenuorder_confirm(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "api/API_sidemenuorder_confirm.asp.asp?" + "smidx=" + paramStr;// + "&salesCode=" + paramSalesCode + "&stcode=" + GlobalMemberValues.STATION_CODE;
