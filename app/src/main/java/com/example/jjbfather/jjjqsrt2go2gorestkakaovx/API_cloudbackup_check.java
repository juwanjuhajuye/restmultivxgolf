...
public class API_cloudbackup_check extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_cloudbackup_check(String paramStcode) {
        if (!GlobalMemberValues.isStrEmpty(paramStcode)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckCloudBackup_ForAndroid.asp?" + "stcode=" + paramStcode;
            GlobalMemberValues.logWrite("CommandLog", "mStrUrl  : " + mStrUrl + "\n");
        }
    }
