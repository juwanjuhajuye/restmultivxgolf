...
public class EpsonPrinterKitchen3 implements ReceiveListener {
    ...
    public EpsonPrinterKitchen3(Context context){
        ...
        if (mPrinter == null) {
            try {
                ...
                MainActivity.mActivity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        EpsonPrinterShowMsg.showExceptionConnectTest(e, "Printer", mContext, "Kitchen Printer 3");
                    }
                });
                return false;
            }
    ...
    private boolean connectPrinter() {
        ...
        try {
            mPrinter.connect("TCP:" + GlobalMemberValues.NETWORKPRINTERIP4, Printer.PARAM_DEFAULT);
        }
        catch (Exception e) {
    ...
    public boolean connectTestPrinter() {
        ...
        try {
            ...
            MainActivity.mActivity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    EpsonPrinterShowMsg.showExceptionConnectTest(e, "connect", mContext, "Kitchen Printer 3");
                }
            });
        ...
        try {
            ...
            MainActivity.mActivity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    EpsonPrinterShowMsg.showExceptionConnectTest(e, "beginTransaction", mContext, "Kitchen Printer 3");
                }
            });
        }
