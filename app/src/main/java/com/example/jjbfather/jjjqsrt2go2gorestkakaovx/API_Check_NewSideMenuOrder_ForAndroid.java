...
public class API_Check_NewSideMenuOrder_ForAndroid extends AsyncTask {
    final String TAG = "NEWSIDEMENUORDER_CHECK";
    ...
    public API_Check_NewSideMenuOrder_ForAndroid(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Check_NewSideMenuOrder_ForAndroid.asp?sidx=" + paramStr + "&stcode=" + GlobalMemberValues.STATION_CODE;
