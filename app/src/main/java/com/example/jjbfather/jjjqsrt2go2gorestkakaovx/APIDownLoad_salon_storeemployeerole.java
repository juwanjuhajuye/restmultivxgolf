 ...
 */
public class APIDownLoad_salon_storeemployeerole extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_storeemployeerole";
            ...
            while (eventType != XmlPullParser.END_DOCUMENT){
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isPossible && isDataTag) {
                        ...
                        if (tagName.equals("rolename")) {
                            rolename = xpp.getText();
                        }
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        mInsertSqlQuery = "insert into " + mDbTableName +
                                " ( " +
                                " idx, scode, sidx, rolename, useyn, delyn, wdate, mdate, permission " +
                                " ) " +
                                " values (" +
                                ...
                                "'" + GlobalMemberValues.getDBTextAfterChecked(rolename, 0) + "', " +
                        ...
                        mUpdateSqlQuery = "update " + mDbTableName + " set " +
                                ...
                                " rolename = '" + GlobalMemberValues.getDBTextAfterChecked(rolename, 0) + "', " +
