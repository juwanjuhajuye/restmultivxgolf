 ...
 */
public class APIDownLoad_salon_storeitemdeletereason extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_storeitemdeletereason";
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        mInsertSqlQuery = "insert into " + mDbTableName +
                                " ( " +
                                " idx, scode, sidx, stcode, aid, name, useyn, delyn, wdate " +
                                " ) " +
                                " values (" +
