...
public class API_weborder_customer_arrive extends AsyncTask {
    final String TAG = "NEWORDERCHECKAPI_CUSTOMER_ARRIVE";
    ...
    public API_weborder_customer_arrive(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Check_NewCurbside_ForAndroid.asp?sidx=" + paramStr + "&stcode=" + GlobalMemberValues.STATION_CODE;
