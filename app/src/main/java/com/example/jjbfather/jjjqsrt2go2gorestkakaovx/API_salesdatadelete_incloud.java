...
public class API_salesdatadelete_incloud extends AsyncTask {
    ...
    public API_salesdatadelete_incloud() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Sales_Delete_ForAndroid.asp?" +
