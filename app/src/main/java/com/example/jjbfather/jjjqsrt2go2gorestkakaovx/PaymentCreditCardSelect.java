...
public class PaymentCreditCardSelect extends Activity {
    ...
    private LinearLayout parentLn, emptyLinearLayout, emptyLinearLayout2, emptyLinearLayout3;
    private Button closeBtn;

    private Button directpaybtn, splitpaybtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_credit_card_select);
