...
public class SettingDeviceLabelPrinter3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_device_label_printer3);
...
//        enableLocationSetting();
    ...
    public void setContents() {
        ...
        String strQuery = "select printername, " +
                ...
                " connectusb " +
                " from salon_storestationsettings_deviceprinter_label3 ";
...
//                    }
                ...
                case R.id.testPrintButton : {
                    ...
                    EpsonLabelPrinter3 epsonLabelPrinter = new EpsonLabelPrinter3(MainActivity.mContext);
...
//                        }
    ...
    public int setSettingsDevicePrinter() {
        ...
        String qurey = "SELECT * FROM salon_storestationsettings_deviceprinter_label3 WHERE idx";
        String qurey_result = dbInit.dbExecuteReadReturnString(qurey);
        if (qurey_result.isEmpty()){
            qurey = "insert into salon_storestationsettings_deviceprinter_label3(printername)values('NO PRINTER')";
            dbInit.dbExecuteWriteReturnValue(qurey);
        }

        // 쿼리문자열을 담을 벡터 변수생성
        Vector<String> strUpdateQueryVec = new Vector<String>();
        String updStrQuery = "update salon_storestationsettings_deviceprinter_label3 set " +
