...
public class API_customerpointdatadelete_incloud extends AsyncTask {
    final String TAG = "SaleDeleteApi";
    ...
    public API_customerpointdatadelete_incloud() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_CustomerPoint_Delete_ForAndroid.asp?" +
