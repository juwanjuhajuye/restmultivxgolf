...
public class API_productdatadelete_incloud extends AsyncTask {
    ...
    public API_productdatadelete_incloud() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Product_Delete_ForAndroid.asp?" +
