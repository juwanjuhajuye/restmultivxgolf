 ...
 */
public class APIDownLoad_online_orders extends AsyncTask {
    ...
    String salesItems = "";
    String status = "";
    String kitchenprintedyn = "";
    String deliverypickupfee = "";
    String customerOrderNumber = "";
    String customerAddressAll = "";
    String useDcomYN = "";
    String carInfo_License = "";
    String carInfo_Color = "";
    String carInfo_Type = "";
    String carInfo_ParkingSpace = "";
    String onlinetype = "";
    ...
    public APIDownLoad_online_orders(String paramFromDate, String paramToDate, String paramSchTxt, String paramSchDeliTake) {
        mStrUrl = GlobalMemberValues.API_WEBORDER_URL + "?" +
    ...
    protected Object doInBackground(Object[] params) {
        ...
        try {
            ...
            while (eventType != XmlPullParser.END_DOCUMENT){
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isPossible && isDataTag) {
                        ...
                        if (tagName.equals("Kitchenprintedyn")) {
                            kitchenprintedyn = xpp.getText();
                        }
                        if (tagName.equals("DeliveryPickupFee")) {
                            deliverypickupfee = xpp.getText();
                        }
                        if (tagName.equals("CustomerOrderNumber")) {
                            customerOrderNumber = xpp.getText();
                        }
                        if (tagName.equals("CustomerAddressAll")) {
                            customerAddressAll = xpp.getText();
                        }
                        if (tagName.equals("UseDcomYN")) {
                            useDcomYN = xpp.getText();
                        }
                        if (tagName.equals("CarInfo_License")){
                            carInfo_License = xpp.getText();
                        }
                        if (tagName.equals("CarInfo_Color")){
                            carInfo_Color = xpp.getText();
                        }
                        if (tagName.equals("CarInfo_Type")){
                            carInfo_Type = xpp.getText();
                        }
                        if (tagName.equals("CarInfo_ParkingSpace")){
                            carInfo_ParkingSpace = xpp.getText();
                        }
                        if (tagName.equals("onlinetype")){
                            onlinetype = xpp.getText();
                        }
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        String[] tempStringArr = {
                                ...
                                salesItems, kitchenprintedyn, deliverypickupfee, customerOrderNumber, customerAddressAll, useDcomYN, carInfo_License, carInfo_Color, carInfo_Type, carInfo_ParkingSpace,
                                pickupdone, onlinetype,

                                // 10112023
                                orderfrom, salescodethirdparty
                        };
                        TemporaryWebOrders temporaryWebOrders = new TemporaryWebOrders(tempStringArr);
                        SaleHistory_web.mCollectionOrdersArrList.add(temporaryWebOrders);
                        ...
                        mDataCollection = "[" + idx + "], [" + salesCode + "], [" + customerId + "], [" +
                                ...
                                saleDate + "], [" + status + "], [" + salesItems + "], [" + kitchenprintedyn + "], [" + deliverypickupfee + "], [" + customerOrderNumber + "] ,[" + customerAddressAll + "] ,[" + useDcomYN + "], [" +
                                carInfo_License + "], [" + carInfo_Color + "], [" + carInfo_Type + "], [" + carInfo_ParkingSpace + "], [" + pickupdone + "], [" + onlinetype + "]" +
            ...
            SaleHistory_web.mDeliveryTakeawayValueFromOutActivity = "";
