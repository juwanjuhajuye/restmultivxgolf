...
public class API_cartdataupload_tocloud extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_cartdataupload_tocloud(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Cart_item_ForAndroid.asp?" + paramStr;

            GlobalMemberValues.logWrite("ApiMStrUrlCartUp", "url : " + mStrUrl + "\n");
        }
    }
