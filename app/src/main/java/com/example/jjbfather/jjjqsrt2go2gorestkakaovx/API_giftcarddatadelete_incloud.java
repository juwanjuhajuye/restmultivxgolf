...
public class API_giftcarddatadelete_incloud extends AsyncTask {
    ...
    public API_giftcarddatadelete_incloud() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_GiftCard_Delete_ForAndroid.asp?" +
