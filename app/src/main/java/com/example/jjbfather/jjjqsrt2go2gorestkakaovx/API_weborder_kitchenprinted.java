...
public class API_weborder_kitchenprinted extends AsyncTask {
    ...
    public API_weborder_kitchenprinted(String paramSalesCode) {
        if (!GlobalMemberValues.isStrEmpty(paramSalesCode)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Weborder_kitchenprinted_ForAndroid.asp?" +
