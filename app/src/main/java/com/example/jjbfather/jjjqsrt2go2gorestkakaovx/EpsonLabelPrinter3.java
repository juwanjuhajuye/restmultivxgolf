...
public class EpsonLabelPrinter3 implements ReceiveListener {
    ...
    public EpsonLabelPrinter3(Context context){
...
//            EpsonPrinterShowMsg.showException(e, "Printer", mContext);
    ...
    public boolean runTestPrintReceiptSequence() {
        ...
        String qurey = "SELECT printername, connectusb, networkprinterip1, networkprinterip2, networkprinterip3, networkprinterip4 FROM salon_storestationsettings_deviceprinter_label3";
