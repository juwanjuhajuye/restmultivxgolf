...
public class API_station_check extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_station_check(String paramStcode, String paramSerialNumber) {
        if (!GlobalMemberValues.isStrEmpty(paramStcode) && !GlobalMemberValues.isStrEmpty(paramSerialNumber)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckStation_ForAndroid.asp?" +
                    "stcode=" + paramStcode + "&serialNumber=" + paramSerialNumber;

            GlobalMemberValues.logWrite("stationcheckurl", "url : " + mStrUrl + "\n");
        }
    }
