...
public class API_download_weborders_receiptjson extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_download_weborders_receiptjson(String paramSalesCode) {
        if (!GlobalMemberValues.isStrEmpty(paramSalesCode)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_DownloadWebOrdersReceiptJson_ForAndroid.asp?salesCode=" +
                    GlobalMemberValues.getEncoderUtf8(GlobalMemberValues.getReplaceText(paramSalesCode, " ", ""));
