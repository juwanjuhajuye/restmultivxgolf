...
public class API_masterpwd extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_masterpwd() {
        if (!GlobalMemberValues.isStrEmpty(GlobalMemberValues.SALON_CODE)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckMasterPwd_ForAndroid.asp?scode=" + GlobalMemberValues.SALON_CODE;
