...
public class API_membermileageupload_tocloud extends AsyncTask {
    ...
    public API_membermileageupload_tocloud(String paramUid, String paramMileage) {

        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Member_Mileage_ForAndroid.asp?" +
                ...
                "&uid=" + GlobalMemberValues.getEncoderUtf8(paramUid) +
                "&mileage=" + GlobalMemberValues.getEncoderUtf8(paramMileage);
