...
public class API_cartdatauploaddel_tocloud extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_cartdatauploaddel_tocloud(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Cart_item_Delete_ForAndroid.asp?" + paramStr;
