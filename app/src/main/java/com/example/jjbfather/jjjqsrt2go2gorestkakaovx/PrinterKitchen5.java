 ...
 */
public class PrinterKitchen5 {
    public PrinterKitchen5() {
        // 프린트에 사용된 언어 설정
...
//            alert.show();
    ...
    public void printKitchenPosbank(final JSONObject data) {
        ...
        GlobalMemberValues.logWrite("kitchenPrintLog2", "프린트안 json -- 5 : " + data.toString() + "\n");
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                // 먼저 kitchen printer5 에 해당되는 food 가 있는지 확인한다. ---------------------------------------------------------------
                int tempItemCount = 0;
                if (!GlobalMemberValues.isStrEmpty(str_saleitemlist)) {
                    ...
                    for (int i = 0; i < strOrderItemsList.length; i++) {
                        ...
                        if (GlobalMemberValues.isKitchenPrinting("5", tempItemIdx)) {
                            tempItemCount++;
                        }
                    }
                }
                ...
                if (tempItemCount > 0) {
                    ...
                    if (!GlobalMemberValues.isStrEmpty(str_customerPagerNumber)) {
                        if (GlobalMemberValues.getKitchenPrinterTextSize().equals("R")) {
                            GlobalMemberValues.posbankPrintText6("No. " + str_customerPagerNumber + "\n\n", 1, attribute, 3, false);
                        } else {
                    ...
                    titleText1 +=  " \n";
                    GlobalMemberValues.posbankPrintText6(titleText1, 1, attribute, 0, false);
                    ...
                    if (GlobalMemberValues.isKitchenOrderNumberSectionViewOn()) {
                        ...
                        GlobalMemberValues.posbankPrintText6(titleText2, 0, attribute, 1 + tempAddTextSize, false);
                    }
                     ...
                     **/
                    titleText3 = "------------------------------------------\r\n";
                    GlobalMemberValues.posbankPrintText6(titleText3, 1, attribute, 0, false);
                    ...
                    if (!GlobalMemberValues.isStrEmpty(str_saleitemlist)) {
                        ...
                        GlobalMemberValues.posbankPrintText6(main_Text, 0, attribute, 1 + tempAddTextSize, false);
                        //main_Text += "------------------------------------------\r\n";
                        //GlobalMemberValues.posbankPrintText6(main_Text, 1, attribute, 0, false);
                    }

                    if (!GlobalMemberValues.isStrEmpty(str_customermemo)) {
                        memo_Text = "[Note]" + "\n";
                        GlobalMemberValues.posbankPrintText6(memo_Text, 0, attribute, 0, false);
                        memo_Text = str_customermemo + "\n";
                        GlobalMemberValues.posbankPrintText6(memo_Text, 0, attribute, 1, false);
                        memo_Text = "------------------------------------------\r\n";
                        GlobalMemberValues.posbankPrintText6(memo_Text, 1, attribute, 0, false);
                    }

                    // receipt footer 프린터 ----------------------------------------------------------------------------------
                    String footer_kitchen = GlobalMemberValues.getReceiptFooterKitchen6();
                    if (!GlobalMemberValues.isStrEmpty(footer_kitchen)) {
                        GlobalMemberValues.posbankPrintText6(footer_kitchen, 1, 0, 0, false);
                    ...
                    GlobalMemberValues.posbankPrintText6(customerText, 0, attribute, 0, false);
    ...
    public void printTestPosbank(final JSONObject data) {
        ...
        Thread thread = new Thread(){
            ...
            public void run(){
                ...
                GlobalMemberValues.posbankPrintText6(testTxt, 1, attribute, 0, false);
                PosbankPrinter6.mPrinter.cutPaper(true);

                //PosbankPrinter6.mPrinter.kickOutDrawer(Printer.DRAWER_CONNECTOR_PIN2);
                GlobalMemberValues.disconnectPrinter6();
