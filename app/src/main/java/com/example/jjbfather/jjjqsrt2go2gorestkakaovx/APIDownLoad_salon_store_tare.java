 ...
 */
public class APIDownLoad_salon_store_tare extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_store_tare";
            ...
            while (eventType != XmlPullParser.END_DOCUMENT){
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isPossible && isDataTag) {
                        ...
                        if (tagName.equals("tarename")) {
                            tarename = xpp.getText();
                        }
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        mInsertSqlQuery = "insert into " + mDbTableName +
                                " ( " +
                                " idx, scode, sidx, stcode, aid, tarename, tareweight, useyn, delyn, wdate " +
                                " ) " +
                                " values (" +
                                ...
                                "'" + GlobalMemberValues.getDBTextAfterChecked(tarename, 0) + "', " +
                        ...
                        mUpdateSqlQuery = "update " + mDbTableName + " set " +
                                ...
                                " tarename = '" + GlobalMemberValues.getDBTextAfterChecked(tarename, 0) + "', " +
