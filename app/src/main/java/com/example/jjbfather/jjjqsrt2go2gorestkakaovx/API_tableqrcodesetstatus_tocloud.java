...
public class API_tableqrcodesetstatus_tocloud extends AsyncTask{
        final String TAG = "API_tableqrcodesetstatus_tocloud_logjjj";
        ...
        String tagName = "";
        // API ReturnCode
        public String mApiReturnCode = "";
        URL mUrl;
        public boolean mFlag;
        public Vector<String> sqlQueryVec = new Vector<String>();

    public API_tableqrcodesetstatus_tocloud(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_TableQRCodeSetStatus.asp?" + "sidx=" + GlobalMemberValues.STORE_INDEX + "&" + paramStr;
