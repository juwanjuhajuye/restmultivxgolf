 ...
 */
public class APIDownLoad_salon_storeservice_additional extends AsyncTask {

    /** 데이터베이스 테이블 필드값 선언 및 초기화 ********************/
    /** 테이블에 따라 여기를 수정해야 함 ********************/
    String mDbTableName = "salon_storeservice_additional";
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    ...
                    if (isReturnCode && tagName.equals("ReturnCode")) {
                        ...
                        if (mApiReturnCode.equals("00")) {
                            isPossible = true;
                            GlobalMemberValues.logWrite("salon_storeservice_additional", "성공" + "\n");
                        } else {
                            isPossible = false;
                            GlobalMemberValues.logWrite("salon_storeservice_additional", "에러" + "\n");
                        }
                        GlobalMemberValues.logWrite("salon_storeservice_additional", "ReturnCode : " + mApiReturnCode + "\n");
                    }

                    if (isPossible && isDataTag) {
                        //GlobalMemberValues.logWrite("salon_storeservice_additional", "성공일때만.." + "\n");
                        ...
                        if (tagName.equals("addname")) {
                            addname = xpp.getText();
                        }
                        if (tagName.equals("addprice")) {
                            addprice = xpp.getText();
                        }
                        if (tagName.equals("adduseyn")) {
                            adduseyn = xpp.getText();
                        }
                    ...
                    if (tagName.equals("Data")) {
                        ...
                        mInsertSqlQuery = "insert into " + mDbTableName +
                                " ( " +
                                " idx, scode, sidx, midx, svcidx, addname, addprice, adduseyn, " +
                                " sortnum, wdate, mdate " +
                                " ) " +
                                " values (" +
                                ...
                                "'" + GlobalMemberValues.getDBTextAfterChecked(addname, 0) + "', " +
                                "'" + GlobalMemberValues.getDBTextAfterChecked(addprice, 0) + "', " +
                                "'" + GlobalMemberValues.getDBTextAfterChecked(adduseyn, 0) + "', " +
                        ...
                        mUpdateSqlQuery = "update " + mDbTableName + " set " +
                                ...
                                " addname = '" + GlobalMemberValues.getDBTextAfterChecked(addname, 0) + "', " +
                                " addprice = '" + GlobalMemberValues.getDBTextAfterChecked(addprice, 0) + "', " +
                                " adduseyn = '" + GlobalMemberValues.getDBTextAfterChecked(adduseyn, 0) + "', " +
...
//                        }
                        ...
                        GlobalMemberValues.logWrite("salon_storeservice_additional", "mQueryCollection : " + mQueryCollection);
                        /** 멤버변수 초기화 ******************************/
                        isDataTag = false;
                        mInsertSqlQuery = "";
                        mUpdateSqlQuery = "";
            ...
            GlobalMemberValues.logWrite("salon_storeservice_additional", "예외발생 : " + e.getMessage());
        }
