...
public class SettingsDeviceKitchenPrinter4 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_device_kitchen_printer4);
    ...
    public void setContents() {
        ...
        String strQuery = "select printername, autoreceipt, receiptfontsize, receiptpapercount, receiptfooter, " +
                ...
                " from salon_storestationsettings_deviceprinter5 ";
...
//                 GlobalMemberValues.displayDialog(context, "NZ Salon", "Under Construction", "Close");
                         ...
                         new AlertDialog.Builder(mActivity)
                                 ...
                                 .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                     ...
                                     public void onClick(DialogInterface dialogInterface, int i) {
                                         //connect
                                         Sam4GiantPrinter.Sam4sPrinterReset("4");
                                         try {
                                             Thread.sleep(2000);
                                         } catch (InterruptedException e) {
                                             e.printStackTrace();
                                         }
                                         GlobalMemberValues.printReceiptByKitchen4(null, context, "testprint4");
                                     }
                                 })
                ...
                case R.id.saveSettingsDevicePrinterButton : {
                    ...
                    if (resultValue > 0) {
                        ...
                        switch (mSavedPrinterName) {
                            case "STAR" : {
                                GlobalMemberValues.printReceiptByKitchen1(null, context, "testprint4");
                                break;
                            }
                            case "PosBank" : {
                                // 테스트 프린트
                            ...
                            case "Elo" : {
                                GlobalMemberValues.printReceiptByKitchen4(null, context, "testprint");
                                break;
                            }
                            case "Giant-100" : {
                                Sam4GiantPrinter giantPrinter = new Sam4GiantPrinter();
                                ...
                                GlobalMemberValues.NETWORKPRINTERIP5 = tempip;

                                String tempPort = networkPrinterPortTextView.getText().toString();
                                GlobalMemberValues.NETWORKPRINTERPORT5 = tempPort;
    ...
    public int setSettingsDevicePrinter() {
        ...
        String updStrQuery = "update salon_storestationsettings_deviceprinter5 set " +
        ...
        if (strUpdateQueryVec.size() > 0) {
            ...
            if (returnResult == "N" || returnResult == "") {
                ...
                GlobalMemberValues.kitchenprinter4_papercount = insReceiptpapercount;
    ...
    AdapterView.OnItemSelectedListener mPrinternameSpinnerItemSelectedListener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (selectedItemPrinterNameSpinner.equals("PosBank")) {
                // posbank connect....!
                PosbankPrinter5 posbankPrinter5 = new PosbankPrinter5(context, "SETTINGS");
                posbankPrinter5.setConnect(true);
            }
            if (!selectedItemPrinterNameSpinner.equals("Giant-100")) {
                // Giant 100
