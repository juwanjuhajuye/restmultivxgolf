...
public class API_SMS_Send_Msg extends AsyncTask {
    final String TAG = "API_SMS_Send_Msg";
    ...
    public API_SMS_Send_Msg(String paramOrderNum, String paramPhoneNum, String paramMsg) {
        if (!GlobalMemberValues.isStrEmpty(paramPhoneNum)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_SMS_SendMsg.asp?sidx=" + GlobalMemberValues.STORE_INDEX + "&customerordernum=" + paramOrderNum +
                    "&tophonenum=" + paramPhoneNum + "&msgcontents=" + paramMsg;
