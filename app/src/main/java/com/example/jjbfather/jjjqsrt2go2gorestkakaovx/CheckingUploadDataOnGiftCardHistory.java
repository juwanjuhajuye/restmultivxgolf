...
public class CheckingUploadDataOnGiftCardHistory {
    final String TAG = "CheckingUploadDataOnGiftCardHistoryLog";

    public CheckingUploadDataOnGiftCardHistory() {
        //
    }

    public boolean checkDataInCloud(boolean paramIsService) {
        // 테이블
        String tblName = "salon_storegiftcard_number_history";
        // 결과값
        ...
        if (GlobalMemberValues.GLOBALNETWORKSTATUS > 0) {
            ...
            String strQuery = "select idx, gcNumber from " + tblName +
            ...
            while (resultCursor.moveToNext()) {
                ...
                String tempGcNumber = GlobalMemberValues.getDBTextAfterChecked(resultCursor.getString(1), 1);
