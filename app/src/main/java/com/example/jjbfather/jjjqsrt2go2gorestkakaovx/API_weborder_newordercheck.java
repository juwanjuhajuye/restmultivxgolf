...
public class API_weborder_newordercheck extends AsyncTask {
    final String TAG = "NEWORDERCHECKAPI";
    ...
    public API_weborder_newordercheck(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_Check_NewOrder_ForAndroid.asp?sidx=" + paramStr + "&stcode=" + GlobalMemberValues.STATION_CODE;
