...
public class API_download_membermileage extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_download_membermileage(String paramUid) {
        if (!GlobalMemberValues.isStrEmpty(paramUid)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_DownloadMemberMileage_ForAndroid.asp?scode=" + GlobalMemberValues.SALON_CODE +
                    "&sidx=" + GlobalMemberValues.STORE_INDEX + "&uid=" + GlobalMemberValues.getEncoderUtf8(GlobalMemberValues.getReplaceText(paramUid, " ", "|||"));
