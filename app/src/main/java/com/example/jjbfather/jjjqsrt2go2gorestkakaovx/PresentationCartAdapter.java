...
public class PresentationCartAdapter extends BaseAdapter {
    Context mContext;
    ...
    public PresentationCartAdapter(Context context, int alayout, ArrayList<TemporarySaleCart> aarSrc) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String itemSaveType = mArSrc.get(position).mSaveType;
        ...
        float tempFontSize1 = 22;
        float tempFontSize2 = 12;
        ...
        if (!GlobalMemberValues.isStrEmpty(mArSrc.get(position).mCategoryColor)) {
            ...
            tvCategoryColor.setBackgroundColor(Color.parseColor("#F0F0F0"));
        }
...
//            tvQty.setBackgroundResource(R.drawable.roundlayout_background_qty);
        ...
        tvEach.setTextColor(Color.parseColor("#003572"));
        if (!(itemSaveType == "8" || itemSaveType == "9")) {
            tvEach.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));
        } else {
            tvEach.setTypeface(Typeface.defaultFromStyle(Typeface.ITALIC));
        }
        tvEach.setText(dollarStr + GlobalMemberValues.getCommaStringForDouble(itemEachValue));
        ...
        if (!GlobalMemberValues.isStrEmpty(tempOptionTxt) || !GlobalMemberValues.isStrEmpty(tempAdditionalTxt1)
            ...
            if (!GlobalMemberValues.isStrEmpty(tempAdditionalTxt2)) {
                if (!GlobalMemberValues.isStrEmpty(tempOptionAddTxt)) {
                    ...
                    tempOptionAddTxt = "[Add Ingredients2]\n" + tempAdditionalTxt2;
                }
            }
            ...
            tvOptionAdd.setText("");
            tvOptionAdd.setTextSize(tempFontSize1 - 3);
            tvOptionAdd.append(tempOptionAddTxt);
            tvOptionAdd.setTextColor(Color.parseColor(itemTextColor));

            tvEach2.setText("");
            tvEach2.setTextSize(tempFontSize1 - 3);
            tvEach2.setTextColor(Color.parseColor("#003572"));
