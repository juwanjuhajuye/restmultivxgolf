...
public class EpsonLabelPrinter implements ReceiveListener {
    ...
    public EpsonLabelPrinter(Context context){
    ...
    public boolean runPrintReceiptSequence_array(JSONArray data, String usb_address) {
...
//                        EpsonPrinterShowMsg.showExceptionConnectTest(e, "Printer", mContext,"Receipt Printer");
    ...
    private boolean createReceiptData(JSONObject data) {
        ...
        getPrintingLn = CloverMakingViewInPrinting.makingLabelLinearLayout(data, "");
        ...
        if (getPrintingLn != null) {
            ...
            try {
                ...
                if (temp_printer_buzzer.equals("Y")){
                    mLabel_Printer.addPulse(Printer.DRAWER_2PIN, 3);
                }
            } catch (Exception e){
