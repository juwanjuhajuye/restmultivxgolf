...
public class SettingsDeviceKitchenPrinter3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_device_kitchen_printer3);
    ...
    public void setContents() {
        ...
        String strQuery = "select printername, autoreceipt, receiptfontsize, receiptpapercount, receiptfooter, " +
                ...
                " from salon_storestationsettings_deviceprinter4 ";
...
//                 GlobalMemberValues.displayDialog(context, "NZ Salon", "Under Construction", "Close");
                         ...
                         new AlertDialog.Builder(mActivity)
                                 ...
                                 .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                     ...
                                     public void onClick(DialogInterface dialogInterface, int i) {
                                         //connect
                                         Sam4GiantPrinter.Sam4sPrinterReset("3");
                                         try {
                                             Thread.sleep(2000);
                                         } catch (InterruptedException e) {
                                             e.printStackTrace();
                                         }
                                         GlobalMemberValues.printReceiptByKitchen3(null, context, "testprint3");
                                     }
                                 })
                ...
                case R.id.saveSettingsDevicePrinterButton : {
                    ...
                    if (resultValue > 0) {
                        ...
                        switch (mSavedPrinterName) {
                            case "STAR" : {
                                GlobalMemberValues.printReceiptByKitchen1(null, context, "testprint3");
                                break;
                            }
                            case "PosBank" : {
                                // 테스트 프린트
                            ...
                            case "Elo" : {
                                GlobalMemberValues.printReceiptByKitchen3(null, context, "testprint");
                                break;
                            }
                            case "Giant-100" : {
                                Sam4GiantPrinter giantPrinter = new Sam4GiantPrinter();
                                ...
                                GlobalMemberValues.NETWORKPRINTERIP4 = tempip;

                                String tempPort = networkPrinterPortTextView.getText().toString();
                                GlobalMemberValues.NETWORKPRINTERPORT4 = tempPort;
    ...
    public int setSettingsDevicePrinter() {
        ...
        String updStrQuery = "update salon_storestationsettings_deviceprinter4 set " +
        ...
        if (strUpdateQueryVec.size() > 0) {
            ...
            if (returnResult == "N" || returnResult == "") {
                ...
                GlobalMemberValues.kitchenprinter3_papercount = insReceiptpapercount;
    ...
    AdapterView.OnItemSelectedListener mPrinternameSpinnerItemSelectedListener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (selectedItemPrinterNameSpinner.equals("PosBank")) {
                // posbank connect....!
                PosbankPrinter4 posbankPrinter4 = new PosbankPrinter4(context, "SETTINGS");
                posbankPrinter4.setConnect(true);
            }
            if (!selectedItemPrinterNameSpinner.equals("Giant-100")) {
                // Giant 100
