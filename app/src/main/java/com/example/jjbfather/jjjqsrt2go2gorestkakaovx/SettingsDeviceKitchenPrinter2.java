...
public class SettingsDeviceKitchenPrinter2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_device_kitchen_printer2);
    ...
    public void setContents() {
        ...
        String strQuery = "select printername, autoreceipt, receiptfontsize, receiptpapercount, receiptfooter, " +
                ...
                " from salon_storestationsettings_deviceprinter3 ";
...
//                 GlobalMemberValues.displayDialog(context, "NZ Salon", "Under Construction", "Close");
                         ...
                         new AlertDialog.Builder(mActivity)
                                 ...
                                 .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                     ...
                                     public void onClick(DialogInterface dialogInterface, int i) {
                                         //connect
                                         Sam4GiantPrinter.Sam4sPrinterReset("2");
                                         try {
                                             Thread.sleep(2000);
                                         } catch (InterruptedException e) {
                                             e.printStackTrace();
                                         }
                                         GlobalMemberValues.printReceiptByKitchen2(null, context, "testprint2");
                                     }
                                 })
                ...
                case R.id.saveSettingsDevicePrinterButton : {
                    ...
                    if (resultValue > 0) {
                        ...
                        switch (mSavedPrinterName) {
                            case "STAR" : {
                                GlobalMemberValues.printReceiptByKitchen1(null, context, "testprint2");
                                break;
                            }
                            case "PosBank" : {
                                // 테스트 프린트
                            ...
                            case "Elo" : {
                                GlobalMemberValues.printReceiptByKitchen2(null, context, "testprint");
                                break;
                            }
                            case "Giant-100" : {
                                Sam4GiantPrinter giantPrinter = new Sam4GiantPrinter();
                                ...
                                GlobalMemberValues.NETWORKPRINTERIP3 = tempip;

                                String tempPort = networkPrinterPortTextView.getText().toString();
                                GlobalMemberValues.NETWORKPRINTERPORT3 = tempPort;
    ...
    public int setSettingsDevicePrinter() {
        ...
        String updStrQuery = "update salon_storestationsettings_deviceprinter3 set " +
        ...
        if (strUpdateQueryVec.size() > 0) {
            ...
            if (returnResult == "N" || returnResult == "") {
                ...
                GlobalMemberValues.kitchenprinter2_papercount = insReceiptpapercount;
    ...
    AdapterView.OnItemSelectedListener mPrinternameSpinnerItemSelectedListener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (selectedItemPrinterNameSpinner.equals("PosBank")) {
                // posbank connect....!
                PosbankPrinter3 posbankPrinter3 = new PosbankPrinter3(context, "SETTINGS");
                posbankPrinter3.setConnect(true);
            }
            if (!selectedItemPrinterNameSpinner.equals("Giant-100")) {
                // Giant 100
