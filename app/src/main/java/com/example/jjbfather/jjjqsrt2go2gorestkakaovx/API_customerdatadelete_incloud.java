...
public class API_customerdatadelete_incloud extends AsyncTask {
    ...
    public API_customerdatadelete_incloud() {
        mStrUrl = GlobalMemberValues.API_WEB + "API_UP_Customer_Delete_ForAndroid.asp?" +
