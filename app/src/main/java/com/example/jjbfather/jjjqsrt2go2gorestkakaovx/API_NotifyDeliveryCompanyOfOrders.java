...
public class API_NotifyDeliveryCompanyOfOrders extends AsyncTask {
    String mReturnValue = "";
    ...
    public API_NotifyDeliveryCompanyOfOrders(String salecode) {
        if (!GlobalMemberValues.isStrEmpty(salecode)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_NotifyDeliveryCompanyOfOrders.asp?salescode=" + salecode;
