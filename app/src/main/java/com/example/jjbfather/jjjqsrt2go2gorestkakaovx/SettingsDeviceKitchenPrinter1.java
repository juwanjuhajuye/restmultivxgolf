...
public class SettingsDeviceKitchenPrinter1 extends Activity {
    ...
    public static String selectedItemPrintLanguageSpinner = GlobalMemberValues.PRINTERGROUPKITCHEN[0];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_settings_device_kitchen_printer1);
    ...
    public void setContents() {
        ...
        String strQuery = "select printername, autoreceipt, receiptfontsize, receiptpapercount, receiptfooter, " +
                ...
                " from salon_storestationsettings_deviceprinter2 ";
        ...
        networkIpTextView1.setOnClickListener(logSaveListener);
        networkIpTextView2.setOnClickListener(logSaveListener);
        networkIpTextView3.setOnClickListener(logSaveListener);
        networkIpTextView4.setOnClickListener(logSaveListener);
        networkPrinterPortTextView.setOnClickListener(logSaveListener);
        ...
        receiptfooterEditText.setOnClickListener(logSaveListener);
        ...
        kitchenPrintingSwitch.setOnClickListener(logSaveListener);
...
//                    }
                        ...
                        new AlertDialog.Builder(mActivity)
                                ...
                                .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        //connect
                                        Sam4GiantPrinter.Sam4sPrinterReset("1");
                                        try {
                                            Thread.sleep(2000);
                                        } catch (InterruptedException e) {
                                            e.printStackTrace();
                                        }
                                        GlobalMemberValues.printReceiptByKitchen1(null, context, "testprint1");
                                    }
                                })
                    ...
                    if (resultValue > 0) {
                        ...
                        switch (mSavedPrinterName) {
                            ...
                            case "PosBank" : {
                                ...
                                // 연결을 끊는다..
                                GlobalMemberValues.disconnectPrinter2();
                                GlobalMemberValues.printReceiptByKitchen1(null, context, "testprint");
                                break;
                            }
                            case "Elo" : {
                                GlobalMemberValues.printReceiptByKitchen1(null, context, "testprint");
                                // 첫번째 주방프린터가 Elo 일 경우 나머지 주방프린터는 모두 No Printer 로 초기화한다.
                                GlobalMemberValues.setNoPrinterInKitchenPrinter();
                                break;
                            }
                            case "Giant-100" : {
                                Sam4GiantPrinter giantPrinter = new Sam4GiantPrinter();
                                ...
                                GlobalMemberValues.NETWORKPRINTERIP2 = tempip;

                                String tempPort = networkPrinterPortTextView.getText().toString();
                                GlobalMemberValues.NETWORKPRINTERPORT2 = tempPort;
    ...
    public int setSettingsDevicePrinter() {
        ...
        String updStrQuery = "update salon_storestationsettings_deviceprinter2 set " +
        ...
        if (strUpdateQueryVec.size() > 0) {
            ...
            if (returnResult == "N" || returnResult == "") {
                ...
                GlobalMemberValues.kitchenprinter1_papercount = insReceiptpapercount;
    ...
    AdapterView.OnItemSelectedListener mPrinternameSpinnerItemSelectedListener = new AdapterView.OnItemSelectedListener() {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            if (selectedItemPrinterNameSpinner.equals("PosBank")) {
                // posbank connect....!
                PosbankPrinter2 posbankPrinter2 = new PosbankPrinter2(context, "SETTINGS");
                posbankPrinter2.setConnect(true);
            }
            if (!selectedItemPrinterNameSpinner.equals("Giant-100")) {
                // Giant 100
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.networkPrinterPortTextView :
                    LogsSave.saveLogsInDB(179);
                    break;
                case R.id.receiptfooterEditText :
                    LogsSave.saveLogsInDB(180);
                    break;
                case R.id.kitchenPrintingSwitch :
                    LogsSave.saveLogsInDB(181);
                    break;
            }
        }
    };
