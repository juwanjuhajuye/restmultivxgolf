...
public class API_checkinguploaddata_incloud extends AsyncTask {
    final String TAG = "checkingdataapilog";
    ...
    public API_checkinguploaddata_incloud(String paramStr) {
        if (!GlobalMemberValues.isStrEmpty(paramStr)) {
            mStrUrl = GlobalMemberValues.API_WEB + "API_CheckingUploadData_ForAndroid.asp?" + paramStr;
